        ...
        <div className='flex flex-row justify-between items-center'>
          ...
          <div className='flex justify-end items-center w-auto'>
            <ul className='flex items-center gap-3 md:gap-6'>
              {/* ---------------------------------- BURGER MENU ---------------------------------- */}
              <li className='block md:hidden p-1 rounded-full ease-in-out duration-300 hover:bg-gray-100 active:bg-gray-100'>
              ...
              {/* ----------------------------------- CART MENU ----------------------------------- */}
              <li className='p-1 rounded-full ease-in-out duration-300 active:bg-gray-100'>
